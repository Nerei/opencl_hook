...
const static char* path = "c:/Windows/System32/OpenCL.dll";
...
//#define __stdcall
    ...
    //Platform API
    extern CL_API_ENTRY cl_int __stdcall
        clGetPlatformIDs(cl_uint num_entries, cl_platform_id * platforms, cl_uint * num_platforms)
    {
        typedef cl_int TYPE(cl_uint num_entries, cl_platform_id * platforms, cl_uint * num_platforms);
    ...
    {
        typedef cl_int TYPE(cl_platform_id platform, cl_platform_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    {
        typedef cl_int TYPE(cl_platform_id platform, cl_device_type device_type, cl_uint num_entries, cl_device_id * devices, cl_uint * num_devices) ;
    ...
    {
        typedef cl_int TYPE(cl_device_id device, cl_device_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    //Context APIs 
    extern CL_API_ENTRY cl_context __stdcall
    ...
    {
        typedef cl_context TYPE(const cl_context_properties * properties, cl_uint num_devices, const cl_device_id * devices, 
            void (__stdcall * pfn_notify)(const char *, const void *, size_t, void *), void * user_data, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_context __stdcall
        clCreateContextFromType(const cl_context_properties * properties, cl_device_type device_type, void (__stdcall *pfn_notify )(const char *, const void *, size_t, void *),void * user_data, cl_int * errcode_ret)
    {
        typedef cl_context TYPE(const cl_context_properties * properties, cl_device_type device_type, void (__stdcall *pfn_notify )(const char *, const void *, size_t, void *), void * user_data, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_int __stdcall clRetainContext(cl_context context)
    {
        typedef cl_int TYPE(cl_context context);
    ...
    {
        typedef cl_int TYPE(cl_context context, cl_context_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    //Command Queue APIs
    extern CL_API_ENTRY cl_command_queue __stdcall
        clCreateCommandQueue(cl_context context, cl_device_id device, cl_command_queue_properties properties, cl_int * errcode_ret)
    {
        typedef cl_command_queue TYPE(cl_context context, cl_device_id device, cl_command_queue_properties properties, cl_int * errcode_ret);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_command_queue_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    //Memory Object APIs
    extern CL_API_ENTRY cl_mem __stdcall
        clCreateBuffer(cl_context context, cl_mem_flags flags, size_t size, void * host_ptr, cl_int * errcode_ret)
    {
        typedef cl_mem TYPE(cl_context context, cl_mem_flags flags, size_t size, void * host_ptr, cl_int * errcode_ret);
    ...
    {
        typedef cl_mem TYPE(cl_mem buffer, cl_mem_flags flags, cl_buffer_create_type buffer_create_type, const void * buffer_create_info, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_mem __stdcall
        clCreateImage2D(cl_context context, cl_mem_flags flags, const cl_image_format * image_format, size_t image_width, size_t image_height,
        size_t image_row_pitch, void * host_ptr, cl_int * errcode_ret)
    {
        typedef cl_mem TYPE(cl_context context, cl_mem_flags flags, const cl_image_format * image_format, size_t image_width, size_t image_height,size_t image_row_pitch, void * host_ptr, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_mem __stdcall
        clCreateImage3D(cl_context context, cl_mem_flags flags, const cl_image_format * image_format, size_t image_width, size_t image_height,
        size_t image_depth, size_t image_row_pitch, size_t image_slice_pitch, void * host_ptr, cl_int * errcode_ret)
    {
        typedef cl_mem TYPE(cl_context context, cl_mem_flags flags, const cl_image_format * image_format, size_t image_width, size_t image_height, size_t image_depth, size_t image_row_pitch, size_t image_slice_pitch, void * host_ptr, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_int __stdcall clRetainMemObject(cl_mem memobj)
    {
        typedef cl_int TYPE(cl_mem memobj);
        Type proc = (Type)GetProcAddress(hinstLib, "clRetainMemObject");
        return proc(memobj);
    }

    extern CL_API_ENTRY cl_int __stdcall clReleaseMemObject(cl_mem memobj)
    {
        typedef cl_int TYPE(cl_mem memobj);
    ...
    extern CL_API_ENTRY cl_int __stdcall clGetSupportedImageFormats(cl_context context, cl_mem_flags flags, cl_mem_object_type image_type, cl_uint num_entries, cl_image_format * image_formats, cl_uint * num_image_formats)
    {
        typedef cl_int TYPE(cl_context context, cl_mem_flags flags, cl_mem_object_type image_type, cl_uint num_entries, cl_image_format * image_formats, cl_uint * num_image_formats) ;
    ...
    {
        typedef cl_int TYPE(cl_mem memobj, cl_mem_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret) ;
    ...
    {
        typedef cl_int TYPE(cl_mem image, cl_image_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret) ;
    ...
    extern CL_API_ENTRY cl_int __stdcall clSetMemObjectDestructorCallback( cl_mem memobj, void (__stdcall * pfn_notify)( cl_mem memobj, void* user_data), void * user_data )
    {
        typedef cl_int TYPE( cl_mem memobj, void (__stdcall * pfn_notify)( cl_mem memobj, void* user_data), void * user_data );
        Type proc = (Type)GetProcAddress(hinstLib, "clSetMemObjectDestructorCallback");
        return proc(memobj, pfn_notify, user_data);
    }

    //Sampler APIs 
    extern CL_API_ENTRY cl_sampler __stdcall
        clCreateSampler(cl_context context, cl_bool normalized_coords, cl_addressing_mode addressing_mode, cl_filter_mode filter_mode, cl_int * errcode_ret)
    {
        typedef cl_sampler TYPE(cl_context context, cl_bool normalized_coords, cl_addressing_mode addressing_mode, cl_filter_mode filter_mode, cl_int * errcode_ret);
    ...
    extern CL_API_ENTRY cl_int __stdcall clRetainSampler(cl_sampler sampler)
    {
        typedef cl_int TYPE(cl_sampler sampler);
        Type proc = (Type)GetProcAddress(hinstLib, "clRetainSampler");
        return proc(sampler);
    }

    extern CL_API_ENTRY cl_int __stdcall clReleaseSampler(cl_sampler sampler)
    {
        typedef cl_int TYPE(cl_sampler sampler);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clGetSamplerInfo(cl_sampler sampler, cl_sampler_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret)
    {
        typedef cl_int TYPE(cl_sampler sampler, cl_sampler_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    //Program Object APIs 
    extern CL_API_ENTRY cl_program __stdcall
        clCreateProgramWithSource(cl_context context, cl_uint count, const char ** strings, const size_t * lengths, cl_int * errcode_ret)
    {
        typedef cl_program TYPE(cl_context context, cl_uint count, const char ** strings, const size_t * lengths, cl_int * errcode_ret);
    ...
    {
        typedef cl_program TYPE(cl_context context, cl_uint num_devices, const cl_device_id * device_list, const size_t * lengths, const unsigned char ** binaries, cl_int * binary_status, cl_int * errcode_ret);
    ...
    {
        typedef cl_int TYPE(cl_program program);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clBuildProgram(cl_program program, cl_uint num_devices, const cl_device_id * device_list, const char * options, void (__stdcall * pfn_notify)(cl_program program, void * user_data), void * user_data)
    {
        typedef cl_int TYPE(cl_program program, cl_uint num_devices, const cl_device_id * device_list, const char * options, void (__stdcall * pfn_notify)(cl_program program, void * user_data), void * user_data) ;
    ...
    extern CL_API_ENTRY cl_int __stdcall clUnloadCompiler(void)
    {
        typedef cl_int TYPE();
    ...
    {
        typedef cl_int TYPE(cl_program program, cl_program_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    {
        typedef cl_int TYPE(cl_program program, cl_device_id device, cl_program_build_info param_name, size_t param_value_size, void * param_value, size_t * param_value_size_ret);
    ...
    //Kernel Object APIs
    extern CL_API_ENTRY cl_kernel __stdcall clCreateKernel(cl_program program, const char * kernel_name, cl_int * errcode_ret)
    {
        typedef cl_kernel TYPE(cl_program program, const char * kernel_name, cl_int * errcode_ret);
    ...
    {
        typedef cl_int TYPE(cl_program program, cl_uint num_kernels, cl_kernel * kernels, cl_uint * num_kernels_ret);
        Type proc = (Type)GetProcAddress(hinstLib, "clCreateKernelsInProgram");
        return proc(program, num_kernels, kernels, num_kernels_ret);
    }

    extern CL_API_ENTRY cl_int __stdcall clRetainKernel(cl_kernel kernel)
    {
        typedef cl_int TYPE(cl_kernel kernel);
        Type proc = (Type)GetProcAddress(hinstLib, "clRetainKernel");
        return proc(kernel);
    }

    extern CL_API_ENTRY cl_int __stdcall clReleaseKernel(cl_kernel kernel)
    {
        typedef cl_int TYPE(cl_kernel kernel);
    ...
    extern CL_API_ENTRY cl_int __stdcall clSetKernelArg(cl_kernel kernel,cl_uint arg_index,size_t arg_size,const void * arg_value)
    {
        typedef cl_int TYPE(cl_kernel kernel,cl_uint arg_index,size_t arg_size,const void * arg_value);
    ...
    {
        typedef cl_int TYPE(cl_kernel kernel,cl_kernel_info param_name,size_t param_value_size,void * param_value,size_t * param_value_size_ret);
    ...
    {
        typedef cl_int TYPE(cl_kernel kernel,cl_device_id device,cl_kernel_work_group_info param_name,size_t param_value_size,void * param_value,size_t * param_value_size_ret);
    ...
    {
        typedef cl_int TYPE(cl_uint num_events,const cl_event * event_list);
        Type proc = (Type)GetProcAddress(hinstLib, "clWaitForEvents");
        return proc(num_events, event_list);
    }

    extern CL_API_ENTRY cl_int __stdcall
        clGetEventInfo(cl_event event,cl_event_info param_name,size_t param_value_size,void * param_value,size_t * param_value_size_ret)
    {
        typedef cl_int TYPE(cl_event event,cl_event_info param_name,size_t param_value_size,void * param_value,size_t * param_value_size_ret);
    ...
    extern CL_API_ENTRY cl_event __stdcall
        clCreateUserEvent(cl_context context,cl_int * errcode_ret)
    {
        typedef cl_event TYPE(cl_context context,cl_int * errcode_ret);
        Type proc = (Type)GetProcAddress(hinstLib, "clCreateUserEvent");
        return proc(context, errcode_ret);
    }


    extern CL_API_ENTRY cl_int __stdcall clRetainEvent(cl_event event)
    {
        typedef cl_int TYPE(cl_event event);
        Type proc = (Type)GetProcAddress(hinstLib, "clRetainEvent");
        return proc(event);
    }

    extern CL_API_ENTRY cl_int __stdcall clReleaseEvent(cl_event event)
    {
        typedef cl_int TYPE(cl_event event);
    ...
    extern CL_API_ENTRY cl_int __stdcall clSetUserEventStatus(cl_event event,cl_int execution_status)
    {
        typedef cl_int TYPE(cl_event event,cl_int execution_status);
        Type proc = (Type)GetProcAddress(hinstLib, "clSetUserEventStatus");
        return proc(event, execution_status);
    }


    extern CL_API_ENTRY cl_int __stdcall clSetEventCallback( cl_event event, cl_int command_exec_callback_type, void (__stdcall * pfn_notify)(cl_event, cl_int, void *),void * user_data)
    {
        typedef cl_int TYPE( cl_event event, cl_int command_exec_callback_type, void (__stdcall * pfn_notify)(cl_event, cl_int, void *),void * user_data);
    ...
    {
        typedef cl_int TYPE(cl_event event, cl_profiling_info param_name, size_t param_value_size, void * param_value,size_t * param_value_size_ret);
    ...
    extern CL_API_ENTRY cl_int __stdcall clFlush(cl_command_queue command_queue)
    {
        typedef cl_int TYPE(cl_command_queue command_queue);
    ...
    extern CL_API_ENTRY cl_int __stdcall clFinish(cl_command_queue command_queue)
    {
        typedef cl_int TYPE(cl_command_queue command_queue);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueReadBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t cb, 
        void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t cb, 
            void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, const size_t * buffer_origin, const size_t * host_origin, const size_t * region, size_t buffer_row_pitch,
            size_t buffer_slice_pitch, size_t host_row_pitch, size_t host_slice_pitch, void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t cb, const void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, const size_t * buffer_origin, const size_t * host_origin, const size_t * region, 
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_buffer, size_t src_offset, size_t dst_offset, size_t cb, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_buffer, const size_t * src_origin, 
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem image, cl_bool blocking_read, const size_t * origin[3], const size_t * region[3], size_t row_pitch, size_t slice_pitch,
            void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueWriteImage(cl_command_queue command_queue, cl_mem image, cl_bool blocking_write, const size_t * origin[3], const size_t * region[3], size_t input_row_pitch,
        size_t input_slice_pitch, const void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem image, cl_bool blocking_write, const size_t * origin[3], const size_t * region[3], size_t input_row_pitch,
            size_t input_slice_pitch, const void * ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueCopyImage(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_image, const size_t * src_origin[3], const size_t * dst_origin[3],
        const size_t * region[3], cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_image, const size_t * src_origin[3], const size_t * dst_origin[3],
            const size_t * region[3], cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueCopyImageToBuffer(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_buffer, const size_t * src_origin[3], const size_t * region[3], size_t dst_offset,
        cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_buffer, const size_t * src_origin[3], const size_t * region[3], size_t dst_offset,
            cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueCopyBufferToImage(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_image, size_t src_offset, const size_t * dst_origin[3], const size_t * region[3], cl_uint num_events_in_wait_list,
        const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_image, size_t src_offset, const size_t * dst_origin[3], const size_t * region[3], cl_uint num_events_in_wait_list,
            const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY void * __stdcall
    ...
    {
        typedef void* TYPE(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_map, cl_map_flags map_flags, size_t offset, size_t cb, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event, cl_int * errcode_ret) ;
    ...
    extern CL_API_ENTRY void * __stdcall
        clEnqueueMapImage(cl_command_queue command_queue , cl_mem image , cl_bool blocking_map , cl_map_flags map_flags , const size_t * origin[3] , const size_t * region[3] ,
    ...
    {
        typedef void* TYPE(cl_command_queue command_queue , cl_mem image , cl_bool blocking_map , cl_map_flags map_flags , const size_t * origin[3] , const size_t * region[3] ,
            size_t * image_row_pitch, size_t * image_slice_pitch, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event, cl_int * errcode_ret);
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_mem memobj, void * mapped_ptr, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        ...
        cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim, const size_t * global_work_offset, const size_t * global_work_size, const size_t * local_work_size,
            cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall clEnqueueTask(cl_command_queue command_queue, cl_kernel kernel, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_kernel kernel, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall
        clEnqueueNativeKernel(cl_command_queue command_queue, void (*user_func)(void *), void * args, size_t cb_args, 
    ...
    {
        typedef cl_int TYPE(cl_command_queue command_queue, void (*user_func)(void *), void * args, size_t cb_args, 
            cl_uint num_mem_objects, const cl_mem * mem_list, const void ** args_mem_loc, cl_uint num_events_in_wait_list, const cl_event * event_wait_list, cl_event * event);
    ...
    extern CL_API_ENTRY cl_int __stdcall clEnqueueMarker(cl_command_queue command_queue, cl_event *event)
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_event *event);
    ...
    extern CL_API_ENTRY cl_int __stdcall clEnqueueWaitForEvents(cl_command_queue command_queue, cl_uint num_events, const cl_event *event_list )
    {
        typedef cl_int TYPE(cl_command_queue command_queue, cl_uint num_events, const cl_event *event_list );
    ...
    extern CL_API_ENTRY cl_int __stdcall clEnqueueBarrier(cl_command_queue command_queue)
    {
        typedef cl_int TYPE(cl_command_queue command_queue);
    ...
    extern CL_API_ENTRY void * __stdcall clGetExtensionFunctionAddress(const char *func_name)
    {
        typedef void* TYPE(const char *func_name);
...
#pragma comment(linker, "/export:_clBuildProgram")