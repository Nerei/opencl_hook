...
#define EXPT extern "C"
//#define EXPT extern "C" __declspec(dllexport)

//Platform API
EXPT cl_int __stdcall clGetPlatformIDs(cl_uint num_entries, cl_platform_id* platforms, cl_uint* num_platforms)
{
...
EXPT cl_int __stdcall clGetPlatformInfo(cl_platform_id platform, cl_platform_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Device APIs
EXPT cl_int __stdcall clGetDeviceIDs(cl_platform_id platform, cl_device_type device_type, cl_uint num_entries, cl_device_id* devices, cl_uint* num_devices)
{
...
EXPT cl_int __stdcall clGetDeviceInfo(cl_device_id device, cl_device_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Context APIs 
EXPT cl_context __stdcall clCreateContext(const cl_context_properties* properties, cl_uint num_devices, const cl_device_id* devices,
...
EXPT cl_context __stdcall clCreateContextFromType(const cl_context_properties* properties, cl_device_type device_type, void (__stdcall *pfn_notify )(const char *, const void *, size_t, void *),void* user_data, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainContext(cl_context context)
{
...
EXPT cl_int __stdcall clReleaseContext(cl_context context)
{
    typedef cl_int (__stdcall *Type)(cl_context context);
...
EXPT cl_int __stdcall clGetContextInfo(cl_context context, cl_context_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Command Queue APIs
EXPT cl_command_queue __stdcall clCreateCommandQueue(cl_context context, cl_device_id device, cl_command_queue_properties properties, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainCommandQueue(cl_command_queue command_queue)
{
...
EXPT cl_int __stdcall clReleaseCommandQueue(cl_command_queue command_queue)
{
    typedef cl_int (__stdcall *Type)(cl_command_queue command_queue);
...
EXPT cl_int __stdcall clGetCommandQueueInfo(cl_command_queue command_queue, cl_command_queue_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Memory Object APIs
EXPT cl_mem __stdcall clCreateBuffer(cl_context context, cl_mem_flags flags, size_t size, void* host_ptr, cl_int* errcode_ret)
{
...
EXPT cl_mem __stdcall clCreateSubBuffer(cl_mem buffer, cl_mem_flags flags, cl_buffer_create_type buffer_create_type, const void* buffer_create_info, cl_int* errcode_ret)
{
...
EXPT cl_mem __stdcall clCreateImage2D(cl_context context, cl_mem_flags flags, const cl_image_format* image_format, size_t image_width, size_t image_height,
...
EXPT cl_mem __stdcall clCreateImage3D(cl_context context, cl_mem_flags flags, const cl_image_format* image_format, size_t image_width, size_t image_height,
...
EXPT cl_int __stdcall clRetainMemObject(cl_mem memobj)
{
...
EXPT cl_int __stdcall clReleaseMemObject(cl_mem memobj)
{
    typedef cl_int (__stdcall *Type)(cl_mem memobj);
...
EXPT cl_int __stdcall clGetSupportedImageFormats(cl_context context, cl_mem_flags flags, cl_mem_object_type image_type, cl_uint num_entries, cl_image_format* image_formats, cl_uint* num_image_formats)
{
...
EXPT cl_int __stdcall clGetMemObjectInfo(cl_mem memobj, cl_mem_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clGetImageInfo(cl_mem image, cl_image_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clSetMemObjectDestructorCallback( cl_mem memobj, void (__stdcall* pfn_notify)( cl_mem memobj, void* user_data), void* user_data )
{
...
//Sampler APIs 
EXPT cl_sampler __stdcall clCreateSampler(cl_context context, cl_bool normalized_coords, cl_addressing_mode addressing_mode, cl_filter_mode filter_mode, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainSampler(cl_sampler sampler)
{
...
EXPT cl_int __stdcall clReleaseSampler(cl_sampler sampler)
{
    typedef cl_int (__stdcall *Type)(cl_sampler sampler);
...
EXPT cl_int __stdcall clGetSamplerInfo(cl_sampler sampler, cl_sampler_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Program Object APIs 
EXPT cl_program __stdcall clCreateProgramWithSource(cl_context context, cl_uint count, const char ** strings, const size_t* lengths, cl_int* errcode_ret)
{
...
EXPT cl_program __stdcall clCreateProgramWithBinary(cl_context context, cl_uint num_devices, const cl_device_id* device_list, const size_t* lengths, const unsigned char ** binaries, cl_int* binary_status, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainProgram(cl_program program)
{
...
EXPT cl_int __stdcall clReleaseProgram(cl_program program)
{
    typedef cl_int (__stdcall *Type)(cl_program program);
...
EXPT cl_int __stdcall clBuildProgram(cl_program program, cl_uint num_devices, const cl_device_id* device_list, const char* options, void (__stdcall* pfn_notify)(cl_program program, void* user_data), void* user_data)
{
...
EXPT cl_int __stdcall clUnloadCompiler(void)
{
...
EXPT cl_int __stdcall clGetProgramInfo(cl_program program, cl_program_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clGetProgramBuildInfo(cl_program program, cl_device_id device, cl_program_build_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
//Kernel Object APIs
EXPT cl_kernel __stdcall clCreateKernel(cl_program program, const char* kernel_name, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainKernel(cl_kernel kernel)
{
...
EXPT cl_int __stdcall clReleaseKernel(cl_kernel kernel)
{
    typedef cl_int (__stdcall *Type)(cl_kernel kernel);
...
EXPT cl_int __stdcall clSetKernelArg(cl_kernel kernel,cl_uint arg_index,size_t arg_size,const void* arg_value)
{
...
EXPT cl_int __stdcall clGetKernelInfo(cl_kernel kernel,cl_kernel_info param_name,size_t param_value_size,void* param_value,size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clGetKernelWorkGroupInfo(cl_kernel kernel,cl_device_id device,cl_kernel_work_group_info param_name,size_t param_value_size,void* param_value,size_t* param_value_size_ret)
{
...
//Event Object APIs 
EXPT cl_int __stdcall clWaitForEvents(cl_uint num_events,const cl_event* event_list)
{
...
EXPT cl_int __stdcall clGetEventInfo(cl_event event,cl_event_info param_name,size_t param_value_size,void* param_value,size_t* param_value_size_ret)
{
...
EXPT cl_event __stdcall clCreateUserEvent(cl_context context,cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clRetainEvent(cl_event event)
{
...
EXPT cl_int __stdcall clReleaseEvent(cl_event event)
{
    typedef cl_int (__stdcall *Type)(cl_event event);
...
EXPT cl_int __stdcall clSetUserEventStatus(cl_event event,cl_int execution_status)
{
...
EXPT cl_int __stdcall clSetEventCallback( cl_event event, cl_int command_exec_callback_type, void (__stdcall* pfn_notify)(cl_event, cl_int, void *),void* user_data)
{
...
//Profiling APIs 
EXPT cl_int __stdcall clGetEventProfilingInfo(cl_event event, cl_profiling_info param_name, size_t param_value_size, void* param_value,size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clFlush(cl_command_queue command_queue)
{
    typedef cl_int (__stdcall *Type)(cl_command_queue command_queue);
...
EXPT cl_int __stdcall clFinish(cl_command_queue command_queue)
{
    typedef cl_int (__stdcall *Type)(cl_command_queue command_queue);
...
EXPT cl_int __stdcall clEnqueueReadBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_read, size_t offset, size_t cb, 
...
EXPT cl_int __stdcall clEnqueueWriteBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_write, size_t offset, size_t cb, const void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueCopyBuffer(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_buffer, size_t src_offset, size_t dst_offset, size_t cb, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueCopyBufferRect(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_buffer, const size_t* src_origin, const size_t* dst_origin, const size_t* region, size_t src_row_pitch, size_t src_slice_pitch, size_t dst_row_pitch, size_t dst_slice_pitch, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueReadImage(cl_command_queue command_queue, cl_mem image, cl_bool blocking_read, const size_t* origin[3], const size_t* region[3], size_t row_pitch, size_t slice_pitch, void* ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueWriteImage(cl_command_queue command_queue, cl_mem image, cl_bool blocking_write, const size_t* origin[3], const size_t* region[3], size_t input_row_pitch,
...
EXPT cl_int __stdcall clEnqueueCopyImage(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_image, const size_t* src_origin[3], const size_t* dst_origin[3],
...
EXPT cl_int __stdcall clEnqueueCopyImageToBuffer(cl_command_queue command_queue, cl_mem src_image, cl_mem dst_buffer, const size_t* src_origin[3], const size_t* region[3], size_t dst_offset,
...
EXPT cl_int __stdcall clEnqueueCopyBufferToImage(cl_command_queue command_queue, cl_mem src_buffer, cl_mem dst_image, size_t src_offset, const size_t* dst_origin[3], const size_t* region[3], cl_uint num_events_in_wait_list,
                           const cl_event* event_wait_list, cl_event* event)
{
...
EXPT void* __stdcall clEnqueueMapBuffer(cl_command_queue command_queue, cl_mem buffer, cl_bool blocking_map, cl_map_flags map_flags, size_t offset, size_t cb, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event, cl_int* errcode_ret) 
{
...
EXPT void* __stdcall clEnqueueMapImage(cl_command_queue command_queue , cl_mem image , cl_bool blocking_map , cl_map_flags map_flags , const size_t* origin[3] , const size_t* region[3] ,
...
EXPT cl_int __stdcall clEnqueueUnmapMemObject(cl_command_queue command_queue, cl_mem memobj, void* mapped_ptr, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueTask(cl_command_queue command_queue, cl_kernel kernel, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueNativeKernel(cl_command_queue command_queue, void (*user_func)(void *), void* args, size_t cb_args, 
...
EXPT cl_int __stdcall clEnqueueMarker(cl_command_queue command_queue, cl_event *event)
{
...
EXPT cl_int __stdcall clEnqueueWaitForEvents(cl_command_queue command_queue, cl_uint num_events, const cl_event *event_list )
{
...
EXPT cl_int __stdcall clEnqueueBarrier(cl_command_queue command_queue)
{
    typedef cl_int (__stdcall *Type)(cl_command_queue command_queue);
...
EXPT void* __stdcall clGetExtensionFunctionAddress(const char *func_name)
{
...
EXPT cl_mem __stdcall clCreateFromGLBuffer(cl_context context, cl_mem_flags flags , cl_GLuint bufobj, int* errcode_ret)
{
...
EXPT cl_mem __stdcall clCreateFromGLTexture2D(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int *errcode_ret)
{
...
EXPT cl_mem __stdcall clCreateFromGLTexture3D(cl_context context, cl_mem_flags flags, cl_GLenum target, cl_GLint miplevel, cl_GLuint texture, cl_int* errcode_ret)
{
    typedef cl_mem (__stdcall *Type)(cl_context context, cl_mem_flags flags, cl_GLenum target ,cl_GLint miplevel, cl_GLuint texture, cl_int* errcode_ret);
...
EXPT cl_mem __stdcall clCreateFromGLRenderbuffer(cl_context context, cl_mem_flags flags, cl_GLuint  renderbuffer, cl_int* errcode_ret)
{
...
EXPT cl_int __stdcall clGetGLObjectInfo(cl_mem memobj, cl_gl_object_type* gl_object_type , cl_GLuint* gl_object_name )
{
...
EXPT cl_int __stdcall clGetGLTextureInfo(cl_mem memobj, cl_gl_texture_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret)
{
...
EXPT cl_int __stdcall clEnqueueAcquireGLObjects(cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
...
EXPT cl_int __stdcall clEnqueueReleaseGLObjects(cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event)
{
    typedef cl_int (__stdcall *Type)(cl_command_queue command_queue, cl_uint num_objects, const cl_mem* mem_objects, cl_uint num_events_in_wait_list, const cl_event* event_wait_list, cl_event* event);
...
EXPT cl_int __stdcall clGetGLContextInfoKHR(const cl_context_properties* properties, cl_gl_context_info param_name, size_t param_value_size, void* param_value, size_t* param_value_size_ret ) 
{
...
EXPT cl_int __stdcall clSetCommandQueueProperty(cl_command_queue command_queue, cl_command_queue_properties properties, cl_bool enable, cl_command_queue_properties *old_properties)
{
